...
public class CustomBushDesign extends GenericBlockDesign {
    ...
    public CustomBushDesign(int[] textureids) {
        Texture texture = MoOres.plants;
        setBoundingBox(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F).setQuadNumber(26);
        setTexture(MoOres.plugin, texture.getTexture()).setMinBrightness(1.0F).setMaxBrightness(1.0F);
