...
public class Crystaliteblock extends GenericCubeCustomBlock {
	public Crystaliteblock(Plugin plugin) {
        super(plugin, "Crystalite Block", "http://cdn.spout.org/img/icon/spout_16x16.png", 16);
