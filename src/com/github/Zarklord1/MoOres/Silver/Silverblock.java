...
public class Silverblock extends GenericCubeCustomBlock {
	public Silverblock(Plugin plugin) {
        super(plugin, "Silver Block", "http://cdn.spout.org/img/icon/spout_16x16.png", 16);
