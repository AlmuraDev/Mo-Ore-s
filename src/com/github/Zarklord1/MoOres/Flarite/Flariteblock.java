...
public class Flariteblock extends GenericCubeCustomBlock {
	public Flariteblock(Plugin plugin) {
        super(plugin, "Flarite Block", "http://cdn.spout.org/img/icon/spout_16x16.png", 16);
